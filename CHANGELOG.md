...
### Fixed
- Parse balanced parentheses in ordinary Markdown link destinations before building wiki graph edges, and ignore unbalanced destinations instead of indexing truncated page paths.
