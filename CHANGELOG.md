...
### Fixed
- Parsed balanced and backslash-escaped brackets in ordinary Markdown link text before building wiki graph edges, while preserving valid inner links under an unmatched outer bracket. (#12)
